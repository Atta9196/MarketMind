...
function formatErrorDetails(error, ticker) {
  ...
  if (
    ...
    return `Unable to retrieve market data from ${ticker}. Please check your connection and try again.`
  }
...
export default function OptionsCalculator() {
  ...
  return (
    <div>
      <h1 className="text-[1.75rem] font-bold text-white">Options Pricing Engine</h1>
      ...
      <div className="mt-8 grid gap-5 xl:grid-cols-3">
        <div className="mm-options-card p-6">
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className="mm-input pr-10 [color-scheme:dark]"
                />
                <svg
        ...
        <div className="mm-options-card flex min-h-[560px] flex-col p-6">
          <SectionLabel>2. PROCESSING</SectionLabel>
          <div className="flex flex-1 flex-col items-center justify-center">
            {showError ? (
              <div className="w-full text-center">
                <div className="mx-auto flex h-20 w-20 items-center justify-center rounded-full bg-[#ef4444]">
                  <span className="text-3xl font-bold text-white">!</span>
                </div>
                <p className="mt-5 text-lg font-semibold text-white">Calculation Failed</p>
                <p className="mt-2 text-sm text-[#94a3b8]">
                  We encountered an error while trying to calculate the option price.
                </p>
                <div className="mt-6 rounded-lg border border-[#ef4444]/50 bg-[#ef4444]/5 p-4 text-left">
                  <p className="text-sm font-semibold text-[#ef4444]">Error Details</p>
                  <p className="mt-2 text-sm text-[#94a3b8]">
        ...
        <div className="mm-options-card flex min-h-[560px] flex-col p-6">
          ...
          <div className="flex flex-1 flex-col">
            <p className="text-sm font-medium text-[#94a3b8]">Theoretical Option Price</p>
            <p
      ...
      <div className="mt-8 flex flex-wrap items-center justify-center gap-8 text-sm text-[#64748b]">
        ...
        <div className="flex items-center gap-2">
          <CpuScalingIcon className="h-4 w-4" />
      ...
      <div className="mm-disclaimer mt-6">
